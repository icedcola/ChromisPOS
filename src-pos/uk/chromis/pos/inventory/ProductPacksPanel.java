...
public class ProductPacksPanel extends JPanelTable2 implements ProductPacksEditor.SplitNotify {
    ...
    protected void init() {   
        ...
        lpr = new ListProviderCreator(new PreparedSentence(app.getSession(),
                ...
                "LEFT OUTER JOIN (SELECT PRODUCT, ATTRIBUTESETINSTANCE_ID, SUM(UNITS) AS SUMUNITS FROM STOCKCURRENT WHERE LOCATION = ? GROUP BY PRODUCT, ATTRIBUTESETINSTANCE_ID) S ON P.ID = S.PRODUCT " +
